...
function convert(word){
	...
	if(word=="New_Game") return '<i class="fas fa-gamepad"></i>';
	// if(word=="New_Game") return '<i class="far fa-hand-paper"></i>';
...
if(UserChoice=="New_Game"){
	...
	{
		score(UserPoints=0,ComPoints=0)
	}
	else{
		lose(UserChoice);
	}
